...
export const UserProvider = ({children})=>{
  ...
  const fetchData = async()=>{
    try{
      ...
      // get user Data
      let userResponse = await axios.get('https://village-voice.onrender.com/api/auth/user');
      setUser(userResponse.data.data);
      
      // get suggetion data
      let suggestionResponse = await axios.get('https://village-voice.onrender.com/api/auth/suggestion');
      ...
      // get Contact Data
      let contactResponse = await axios.get('https://village-voice.onrender.com/api/auth/get-contact-data');
      if(!contactResponse){
